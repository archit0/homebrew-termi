...
echo ""
echo "  Agentic mode (iterative AI execution):"
echo "    termi --agent \"find large files and show disk usage\""
echo "    termi --agent \"cleanup all .pyc files in this project\""
echo "    termi --agent \"setup a new git repo with README\""
echo ""
echo "  Options:"
echo "    termi --config       # Change LLM provider"
echo "    termi --help         # Show all options"
echo ""
